...
TEST_CASE("search_intervals") {
  ...
  std::vector<int> ticks  =  {   100  , 200 , 300, 400 ,  500  ,      600  ,  700  , 800, 900 , 1000  , 1100         };

  SUBCASE("no tolerance") {
    auto [first_index, n_indices, interval_start] = search_intervals6(indices,ticks,0);
  ...
  SUBCASE("tolerance") {
    ...
    auto [first_index, n_indices, interval_start] = search_intervals6(indices,ticks,1);
