...
class adjacency_node_iterator {
  ...
  // ctors
    ...
    constexpr
    adjacency_node_iterator(graph_type* g, index_type node_idx)
      : g(g)
      , node_idx(node_idx)
    {}
...
template<class GT>
struct std::iterator_traits<std_e::adjacency_node_iterator<GT>> {
  using type = std_e::adjacency_node_iterator<GT>;
