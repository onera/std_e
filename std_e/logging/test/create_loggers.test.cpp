...
TEST_CASE("create_loggers") {
  ...
  CHECK_THROWS_WITH( std_e::create_loggers(conf_0,"<context>"), "<context> at line 0: missing colon" );
  CHECK_THROWS_WITH( std_e::create_loggers(conf_1,"<context>"), "<context> at line 0: empty logger name" );
  CHECK_THROWS_WITH( std_e::create_loggers(conf_2,"<context>"), "<context> at line 0: too many colons" );
  CHECK_THROWS_WITH( std_e::create_loggers(conf_3,"<context>"), "<context> at line 0: parentheses are not balanced" );

  CHECK_THROWS_WITH( std_e::create_loggers(conf_4,"<context>"),
      "<context> at line 0: printer \"stdout_printer(x,y(z))\":"
  ...
  CHECK_THROWS_WITH( std_e::create_loggers(conf_5,"<context>"),
      "<context> at line 0: printer \"stdout_printer()str\":"
      " must be of the form \"printer_name\" or \"printer_name(arg0,arg1,...)\" but extra characters \"str\" where found at the end" );

  CHECK_THROWS_WITH( std_e::create_loggers(conf_6,"<context>"), "<context> at line 0: stdout_printer needs 0 argument, but 1 given" );
  CHECK_THROWS_WITH( std_e::create_loggers(conf_7,"<context>"), "<context> at line 0: file_printer needs 1 argument, but 0 given" );
  CHECK_THROWS_WITH( std_e::create_loggers(conf_8,"<context>"), "<context> at line 0: file_printer needs 1 argument, but 2 given" );
}
