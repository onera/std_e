...
pivot_partition_i_aux(RA_it first, RA_it last, RA_it_piv piv_first, RA_it_piv piv_last, RA_it_out out_first, Comp comp, RA_it start) -> void {
  if (piv_first==piv_last) return;
  auto k = piv_last-piv_first;
  auto pv_mid = piv_first+k/2;
...
template<class RA_it, class RA_it_piv, class RA_it_out, class Comp = std::less<>> constexpr auto
pivot_partition_indices(RA_it first, RA_it last, RA_it_piv piv_first, RA_it_piv piv_last, RA_it_out out_first, Comp comp = {}) -> void {
